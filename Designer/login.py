...
"}")
        ...
        self.input_user.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("JetBrains Mono")
...
"padding-bottom:7px;")
        ...
        self.gridLayout_2.addWidget(self.input_user, 3, 1, 1, 1)
...
"padding-bottom:7px;")
        ...
        self.gridLayout_2.addWidget(self.input_password, 4, 1, 1, 1)
        self.title_login = QtWidgets.QLabel(self.widget)
        self.title_login.setMinimumSize(QtCore.QSize(190, 71))
