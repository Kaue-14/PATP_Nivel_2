...
ALTER TABLE agendamentos1
ADD COLUMN id_usuario_paciente INT,
ADD COLUMN id_usuario_psicologo INT;


ALTER TABLE agendamentos1
ADD CONSTRAINT fk_agendamento_usuario_paciente
FOREIGN KEY (id_usuario_paciente) REFERENCES usuarios1(id_usuario),
ADD CONSTRAINT fk_agendamento_usuario_psicologo
FOREIGN KEY (id_usuario_psicologo) REFERENCES usuarios1(id_usuario);


	UPDATE agendamentos1 a
	JOIN pacientes1 p ON a.id_paciente = p.id_paciente
	SET a.id_usuario_paciente = p.id_usuario;


SHOW CREATE VIEW v_usuarios;
...
ADD COLUMN id_psicologo INT NULL,
...
UPDATE usuarios1 u
JOIN pacientes1 p ON u.id_usuario = p.id_usuario
SET u.id_paciente = p.id_paciente;

UPDATE usuarios1 u
JOIN psicologos1 ps ON u.id_usuario = ps.id_usuario
SET u.id_psicologo = ps.id_psicologo;


select * from usuarios1;

select * from psicologos1;